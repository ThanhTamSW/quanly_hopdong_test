...
export function ImportSchedules() {
  ...
  const handleDownloadTemplate = async () => {
    try {
      await importApi.downloadTemplate('schedules');
    } catch (error) {
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      formData.append('type', 'schedules');
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await importApi.importSchedules(formData);
      setImportResult({
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Tải file template Excel để điền thông tin lịch dạy
            </p>
            ...
            <div className="space-y-4">
              ...
              >
                {importing ? (
                  ...
                  <>
                    <Upload className="h-4 w-4 mr-2" />
                    Import {validation.validRows} lịch dạy
                  </>
                )}
              </Button>
            </div>
